...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/stocks/{stockID}/registers": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/stocks/{stockID}/registers/last": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "integer",
                        "default": 100,
                        "description": "Max number of registers to return",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/stocks/{stockID}/registers/tendency": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.StockTendencyStatView"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
